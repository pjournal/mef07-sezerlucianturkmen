...
gathered_data <- gather(filtered_spotify_data, key = "feature", value = "percentage",
                        danceability_., valence_., energy_., acousticness_., instrumentalness_.)

ggplot(gathered_data, aes(x = feature, y = percentage, fill = feature)) +
  geom_bar(stat = "identity", position = "dodge", color = "black") +
  labs(title = "Distribution of Musical Features",
       x = "Musical Features",
       y = "Percentage",
       fill = "Feature") +
  theme_minimal()
